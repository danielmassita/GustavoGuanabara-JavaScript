...
// Declarando uma VARIÁVEL COMPOSTA (array)...
var num = []
console.log(num)
...
var num = []
num = [5, 8, 4] // re-declarando (observe, os índices são 0, 1 e 2...)
console.log(num)
num[3] = 6 // a variável composta "num" recebe na posição-índice 3, o valor = 6 pelo maneira automatizada do JavaScript e ECMA
console.log(num)
num.push(7) // .push é um MÉTODO INTERNO do JS e vai adicionar o valor 7 ao final do array, independente do tamanho/índice, no caso na chave 4...
console.log(num)
num.length // sem parênteses, NÃO é um método, .length no JS é um ATRIBUTO que retorna o tamanho de casas, quantos elementos (5 no array)?
console.log(num.length)
num.sort() // com parênteses, VAI ORGANIZAR os valores do array e colocar em ORDEM CRESCENTE (ordenados)...
console.log(num)
...
num.push(1)
num.sort()
console.log(`Foi declarada uma nova array ${num}.`)
...
// Imagina se eu tivesse um código com 200 posições ou mais? Então vamos resumir o código acima na maneira abaixo. A única diferença entre as linhas de códigos são as "chaves", ou as posições de cada vetor. Os índices que mudam, mas as linhas de códigos são as mesmas. Então podemos ir buscar os valores usando as chaves. Podemos CRIAR UMA VARIÁVEL CHAMADA "pos", começa valendo zero e vai até quatro, sendo o limite do vetor. Então eu escrevo um único código e aplico uma estrutura de repetição.

for (var pos = 0; pos < num.length; pos++) {
  console.log(num[pos])
}

// MÃO NA MASSA - vetornatela.js
...
// Agora vamos usar o CÓDIGO TRADICIONAL DO PERCURSO em vetores (para exibição)...
for (pos = 0; pos < valores.length; pos++){
  console.log(`A posição ${pos} tem o valor ${valores[pos]}.`)
}

// Agora vamos usar o método mais minimalista (otimizado pra variáveis compostas e objetos, aka same-same)... A leitura é como: "para cada posição em num, para cada posição na variável composta, eu vou mostrar o num[pos]." Lembrando que essa sintaxe só funciona pra arrays e objetos, que no fundo é a mesma coisa.
...
// Última funcionalidade, é BUSCAR um valor dentro de um array. num.indexOf(7), vai procurar no vetor algum valor que seja 7...
console.log('')
console.log(num)
console.log('')
num.indexOf(7)
console.log(num.indexOf(7))
console.log(`Na busca pelo num.indexOf(7), varrendo o valor == 7, vai retornar a posição 3.`)
console.log('')

// Para o JavaScript, ao utilizar a funcionalidade .indexOf(param) e não encontrar uma ocorrência, o retorno será -1.
num.indexOf(3)
console.log(num.indexOf(3))
console.log(`Na busca pelo num.indexOf(3), varrendo o valor == 3, vai retornar -1.`)
console.log('')
