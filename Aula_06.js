// Aula 06 - Tratamento de dados - Curso JavaScript #06
// https://www.youtube.com/watch?v=OJgu_KCCUSY

/*
PERGUNTAS AULA ANTERIOR
- O que é uma variável? É um espaço na memória, que se atribui um dado, e pode ser alterado, somado, computado, etc...
- Como declarar uma variável numérica inteira ou real usando JS? var numeroInt = 10; var numeroReal = 5.5...
...
/*        
        ABRIR O NODE.JS
            ...
            > nota
            5.5
            > 'O aluno '+nome+', com '+idade+' anos, tirou a nota '+nota+'.' / BIZARRO
            'O aluno Gustavo, com 41 anos, tirou a nota 5.5.'

            TEMPLATE STRING (PLACE HOLDER) `${}`
            `Eu estou aprendendo ${s}` // 'Eu estou aprendendo JavaScript'

            > 'O aluno '+nome+', com '+idade+' anos, tirou a nota '+nota+'.'
            'O aluno Gustavo, com 41 anos, tirou a nota 5.5.'
            > `O aluno ${nome}, com idade de ${idade} anos, tirou a nota ${nota}.`
            'O aluno Gustavo, com idade de 41 anos, tirou a nota 5.5.'            
...
/*
EX 004 - FORMATANDO STRINGS

    <script>
        var nome = window.prompt("Qual é o seu nome?");
        document.write(`Olá, <strong>${nome}</strong>! Seu nome possui ${nome.length} letras. </br>`);
        document.write(`Seu nome em maiúsculas é: ${nome.toUpperCase()}.</br>`); // precisa fechar o () da function!
...
/*
FORMATANDO NÚMEROS (Abrir o Node.JS)
